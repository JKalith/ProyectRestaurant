...
public class InterPedido extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnRegresar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfazMesero/izquierda.png"))); // NOI18N

        btnBorrar.setBackground(new java.awt.Color(0, 0, 0));
        btnBorrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfazMesero/borrar.png"))); // NOI18N

        btnEnviarPedido.setBackground(new java.awt.Color(0, 0, 0));
        btnEnviarPedido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfazMesero/bolsa-de-la-compra.png"))); // NOI18N
